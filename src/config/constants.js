...
export const API_RPT_URL = process.env.REACT_APP_API_RPT_URL;
export const API_ACM_URL = process.env.REACT_APP_API_ACM_URL;
...
export const SUB_SYSTEM_CONTEXT = '/AUD';
